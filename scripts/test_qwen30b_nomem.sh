#!/bin/bash
# =============================================================================
# test_qwen30b_nomem.sh — Qwen3-30B-A3B-FP8 baseline (no memory)
# =============================================================================
set -e
...
# ── Inference ───────────────────────────────────────────────────────────────
CONFIG=$PROJECT/configs/rl_alf_config.qwen30b_nomem.yaml
INFER_LOG=$PROJECT/alfworld_qwen30b_nomem.log
...
# ── 3. run inference (no --checkpoint = empty memory) ────────────────────────
echo "[$(date +%T)] Running baseline inference (Qwen3-30B-A3B, NO memory)..."
